...
from typing import Optional  # thêm vào đầu file nếu chưa có
...
def get_extreme_points(points_data: Dict[str, List[Any]],
                       img_size: Tuple[int, int] = (960, 540)) \
        -> Dict[int, Optional[Tuple[Tuple[np.ndarray, np.ndarray], Any]]]:
...
def loc2img(img: np.ndarray,
            points: Dict[int, Optional[Tuple[Tuple[np.ndarray, np.ndarray], Any]]],
